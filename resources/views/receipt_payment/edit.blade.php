...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form action="{{ url('/reciept-payment/edit/' . $receipt_payment->id) }}" method="POST">
            @csrf
            <div class="d-flex justify-content-between align-items-center p-3 py-0">
                <h4 class="fw-bold py-3 mb-2">
                    ...
                    <a href="{{ url('/client-profile/' . $receipt_payment->client_id) }}" class="text-muted fw-light">/ Receipt
                        - Payemnt</a>
                ...
                <div class="col-md-12">
                    <div class="card invoice-preview-card">
                        <div class="card-body pb-0">
                            <h4 class="my-3">Edit Receipt / Payemnt</h4>
                            <div class="row mx-0">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select id="client_id" required name="client_id" type="text"
                                        ...
                                        @foreach ($clients as $client)
                                            <option {{ $receipt_payment->client_id == $client->id ? 'selected' : '' }}
                                                value="{{ $client->id }}">
                                                {{ $client->name }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select id="type_id" name="type_id" type="text"
                                        ...
                                        @foreach ($types as $type)
                                            <option {{ $receipt_payment->type_id == $type->id ? 'selected' : '' }}
                                                value="{{ $type->id }}">
                                                {{ $type->name }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select id="account" name="account" type="text"
                                        class="select2 form-select form-select-lg" data-allow-clear="true">
                                        <option value="">Select</option>
                                        <option {{ $receipt_payment->account == 'bank' ? 'selected' : '' }} value="bank">
                                            Bank</option>
                                        <option {{ $receipt_payment->client_id == 'cash-in-hand' ? 'selected' : '' }}
                                            value="cash-in-hand">Cash in Hand</option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-select" name="currency_id" id="currency_id">
                                        ...
                                        @foreach ($currencies as $currency)
                                            <option {{ $receipt_payment->currency_id == $currency->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="buy" id="buy"
                                        placeholder="Buy" value="{{ @$receipt_payment->buy }}">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <p class="mb-2">Sell</p>
                                    <input type="number" class="form-control" name="sell" id="sell"
                                        placeholder="Sell" value="{{ @$receipt_payment->sell }}">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <p class="mb-2">Amount</p>
                                    <input type="number" class="form-control" name="amount" id="amount"
                                        placeholder="Amount" value="{{ @$receipt_payment->amount }}">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <p class="mb-2">Converted Amount</p>
                                    <input type="text" class="form-control converted-amount" name="converted_amount"
                                        placeholder="Converted Amount" value="{{ @$receipt_payment->converted_amount }}">
                                </div>
                                <div class="col-md-4">
                                    <div class="form-floating form-floating-outline my-2">
                                        <textarea class="form-control" name="description" rows="5" id="description">{{ @$receipt_payment->description }}</textarea>
