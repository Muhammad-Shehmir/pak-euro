...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center p-3 py-0">
            <h4 class="fw-bold py-3 mb-2"><a href="{{ url('dashboard') }}" class="text-muted fw-light">Dashboard </a><span class="color">/ Account Type
            </h4></span>
                ...
                <div class="card mb-4">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="d-grid p-3 border">
                            <form method="GET" id="myForm" action="{{ url('/account-type') }}"
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input type="text"  class="form-control name-validate"
                                                id="basic-icon-default-fullname" placeholder="Enter Name" value="{{ request('name') }}" name="name"
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input  name="nature" type="text" id="basic-icon-default-phone"
                                            class="form-control phone-mask" placeholder="Enter Nature" value="{{ request('nature') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input  name="category" type="text" id="basic-icon-default-phone"
                                                class="form-control dob-picker" placeholder="Enter Category" aria-label="Enter Your Category"
                                                aria-describedby="basic-icon-default-phone2" value="{{ request('category') }}" />
                                    ...
                                    <div class="d-flex justify-content-end  p-1 py-1">
                                        ...
                                        <a href="{{ url('/account-type') }}"    class="btn btn-danger" tabindex="0"
        ...
        <div class="card">
                        ...
                        @foreach ($account_type as $account)
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-primary me-2 p-2-5"  href="{{ url('/account-type/edit/' . $account->id) }}"><i
                                                class="fa fa-edit"></i> </a>
                                        <form method="post" action="{{ url('/account-type/delete/' . $account->id) }}">
                                            @csrf
            ...
            <div class="card-footer d-flex justify-content-end">
                ...
                {{ $account_type->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
    @include('account_type.add')
    {{-- @include('account_type.delete') --}}


    <script>
        function changePerPage(select) {
            const perPage = select.value;
            window.location.href = `{{ url('account-type') }}?perPage=${perPage}`;
        }
    </script>
