...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2"><a href="{{ url('/dashboard') }}" class="text-muted fw-light">Dashboard </a><a href="{{ url('/discount') }}" class="text-muted fw-light">/ ADiscount</a><span class="color"> /</span><span class="text-heading fw-bold text-color"> Add</span>
        </h4>
        <div class="row">
            <!-- FormValidation -->
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <form method="POST" id="myForm" action="{{ url('/patient/add') }}" enctype="multipart/form-data"
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" required class="form-control "
                                            id="basic-icon-default-fullname" placeholder="Enter Discount Name" name="discount_name"
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-merge mb-2">
                                    <span id="basic-icon-default-phone2" class="input-group-text"><i
                                            class="mdi mdi-sale"></i></span>
                                    <div class="form-floating form-floating-outline">
                                        <input value="0" name="discount" type="text" id="basic-icon-default-phone"
                                            class="form-control"
                                             aria-describedby="basic-icon-default-phone2" />
                                        <label for="basic-icon-default-phone">Discount</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
