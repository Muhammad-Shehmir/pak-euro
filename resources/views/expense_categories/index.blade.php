...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center p-3 py-0">
            <h4 class="fw-bold py-3 mb-2"><a href="{{ url('dashboard') }}" class="text-muted fw-light">Dashboard </a><span class="color">/ Expense Categories
            </h4></span>
                ...
                <div class="card mb-4">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="d-grid p-3 border">
                            <form method="GET" id="myForm" action="{{ url('/expense-categories') }}"
                                ...
                                <div class="d-flex justify-content-end  p-1 py-1">
                                    ...
                                    <a href="{{ url('/expense-categories') }}"    class="btn btn-danger" tabindex="0"
        ...
        <div class="card">
                        ...
                        @foreach ($expense_categories as $expense)
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-primary me-2 p-2-5"   href="{{ url('/expense-categories/edit/' . $expense->id) }}"><i
                                                class="fa fa-edit"></i> </a>
                                        <form method="post" action="{{ url('/expense-categories/delete/' . $expense->id) }}">
                                            @csrf
            ...
            <div class="card-footer d-flex justify-content-end">
                ...
                {{ $expense_categories->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
    @include('expense_categories.add')
    <script>
        function changePerPage(select) {
            const perPage = select.value;
            window.location.href = `{{ url('expense-categories') }}?perPage=${perPage}`;
        }
    </script>
