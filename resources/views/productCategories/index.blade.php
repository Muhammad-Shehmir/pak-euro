...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center p-3 py-0">
            <h4 class="fw-bold py-3 mb-2"><a href="{{ url('dashboard') }}" class="text-muted fw-light">Dashboard </a><span
                    class="color">/ Product Categories
            </h4></span>
                ...
                <div class="card mb-4">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="d-grid p-3 border">
                            <form method="GET" id="myForm" action="{{ url('/product-categories') }}"
                                ...
                                <div class="d-flex justify-content-end  p-1 py-1">
                                    ...
                                    <a href="{{ url('/product-categories') }}" class="btn btn-danger" tabindex="0"><span><i
            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="dt-action-buttons pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <a href="{{ url('/product-category/add') }}" class="btn btn-secondary create-new btn-primary"
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a class="btn btn-primary me-2 p-2-5"
                                            href="{{ url('/product-category/edit/' . $category->id) }}"><i
                                                class="fa fa-edit"></i>
                                        </a>
                                        <form method="post"
                                            action="{{ url('/product-category/delete/' . $category->id) }}">
                                            @csrf
    ...
    <script>
        function changePerPage(select) {
            ...
            window.location.href = `{{ url('product-categories') }}?perPage=${perPage}`;
        }
    </script>
@endsection
