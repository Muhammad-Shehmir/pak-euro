...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center p-3 py-0">
            <h4 class="fw-bold py-3 mb-2"><a href="{{ url('dashboard') }}" class="text-muted fw-light">Dashboard </a><span class="color">/ Tax
            </h4></span>
                ...
                <div class="card mb-4">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="d-grid p-3 border">
                            <form method="GET" id="myForm" action="{{ url('/tax') }}"
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"  class="form-control" id="basic-icon-default-fullname"
                                            placeholder="Enter description" name="description" value="{{ request('description') }}"
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    <span id="basic-icon-default-phone2" class="input-group-text"><i
                                            class="mdi mdi-account-cash"></i></span>
                                    <div class="form-floating form-floating-outline">
                                        <input  name="tax" type="text" id="basic-icon-default-phone"
                                            class="form-control phone-mask" placeholder="Enter Tax" value="{{ request('tax') }}"
                                ...
                                <div class="d-flex justify-content-end  p-1 py-1">
                                    ...
                                    <a href="{{ url('/tax') }}"    class="btn btn-danger" tabindex="0"
                        ...
                        @foreach ($taxes as $tax)
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-primary me-2 p-2-5"  href="{{ url('/tax/edit/' . $tax->id) }}"><i
                                                class="fa fa-edit"></i></a>
                                        <form method="post" action="{{ url('/tax/delete/' . $tax->id) }}">
                                            @csrf
    ...
    @include('taxes.addModal')
    <script>
        function changePerPage(select) {
            const perPage = select.value;
            window.location.href = `{{ url('tax') }}?perPage=${perPage}`;
        }
    </script>
@endsection
