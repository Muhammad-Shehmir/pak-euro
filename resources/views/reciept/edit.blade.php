                                    ...
                                    <dl class="row mb-2 g-2">
                                        ...
                                        <dd class="col-sm-6">
                                            <div class="input-group input-group-merge disabled">
                                                ...
                                                <input type="text" class="form-control" disabled
                                                    ...
                                                    value="{{ $transaction ? (int) $transaction->id : null }}"
                                                    id="invoiceId" />
                                            </div>
                                        </dd>
                                        <dt class="col-sm-6 mb-2 d-md-flex align-items-center justify-content-end">
                                        ...
                                        <dd class="col-sm-6">
                                            ...
                                            {{-- <input type="date" class="form-control date-picker" name="date"
                                                ...
                                                value="{{ \Carbon\Carbon::parse($transaction->created_at)->toDateString() }}" /> --}}
                                        ...
                                        <div class="select2-primary">
                                            <select id="customer_source" name="customer_source" type="text"
                                                ...
                                                @foreach ($customer_sources as $source)
                                                    <option
                                                        {{ $transaction->customer_source_id == $source->id ? 'selected' : '' }}
                                                        value="{{ $source->id }}">
                                                        {{ $source->name }} </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="select2-primary">
                                            <select id="customer_type_id" name="customer_type_id" type="text"
                                                ...
                                                @foreach ($customer_types as $type)
                                                    <option
                                                        {{ $transaction->customer_type_id == $type->id ? 'selected' : '' }}
                                                        value="{{ $type->id }}">
                                                        {{ $type->name }} </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <select id="customer_id" required name="customer_id" type="text"
                                            ...
                                            @foreach ($customers as $customer)
                                                <option {{ $transaction->customer_id == $customer->id ? 'selected' : '' }}
                                                    value="{{ $customer->id }}">
                                    ...
                                    <div class="input-group input-group-merge my-3">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" id="conversion_rate" name="conversion_rate"
                                                value="{{ $transaction->conversion_rate }}" id="basic-icon-default-email"
                                                ...
                                                <div class="row w-100 p-2">
                                                    ...
                                                    <div class="col-md-1 mb-md-0 mb-3">
                                                        ...
                                                        <input type="text" class="form-control amount" name="amount"
                                                            readonly placeholder="Enter Amount"
                                                            value="{{ $item->amount }}" />
                                                    </div>
                                                    <div class="col-md-2 mb-md-0 mb-3">
                                ...
                                <div class="col-md-6 d-flex justify-content-start">
                                    <div class="invoice-calculations">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="fw-semibold" id="due_amount">{{ $transaction->currency->name }}
                                                {{ number_format($totalAmountRemaining, 2, '.', '') ?? '0.00' }}
                                            </span>
                                        </div>
                                        <input type="hidden" class="advance_amount" name="advance_amount" value="">
                                        {{-- <div class="d-flex justify-content-between">
                                    ...
                                    <div class="invoice-calculations">
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <span class="fw-semibold sub_total"
                                                id="sub_total">{{ $transaction->currency->name }}
                                                {{ $transaction->sub_total }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <span class="fw-semibold d-flex">
                                                <input type="number" name="total_service_charge"
                                                    ...
                                                    value="{{ $transaction->total_service_charge }}" placeholder="%" />
                                                <input type="text" name="total_service_charge_amount"
                                                    class="form-control w-px-100"
                                                    value="{{ $transaction->total_service_charge_amount }}"
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <span class="fw-semibold d-flex">
                                                <input type="number" name="total_green_tax_percentage"
                                                    ...
                                                    placeholder="%"
                                                    value="{{ $transaction->total_green_tax_percentage }}" />
                                                <input type="text" name="total_green_tax_amount"
                                                    class="form-control w-px-100" id="total_green_tax_amount"
                                                    placeholder="$" value="{{ $transaction->total_green_tax_amount }}" />
                                            </span>
                                        </div>
                                        <hr />
                                        <div class="d-flex justify-content-between">
                                            <span class="w-px-100">Total:</span>
                                            <input type="hidden" class="total_amount_remaining"
                                                value=" {{ $totalAmountRemaining }}">
                            ...
                            <tbody>
                                @foreach (@$transaction->payments as $payment)
                                    <tr>
                                        ...
                                        <td>{{ $payment->payment_mode == 'Card' ? $payment->payment_mode . ' (Charges = ' . $payment->card_charges . ')' : $payment->payment_mode }}
                                        </td>
                                        <td>{{ @$payment->currency->name }}
                                            {{ number_format($payment->amount_paid, 2, '.', '') }}</td>
                                        <td>{{ @$payment->currency->name }}
                                            {{ number_format($payment->remaining_amount, 2, '.', '') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
<script>
    $(document).ready(function() {
        ...
        $(document).ready(function() {
            $("#total_discount_percentage").on("input", calculateDiscount);
        });
        ...
        $("#payment").on("input", function() {
            ...
            var currency = $('#currency_id option:selected').text() || '$';
            var paidAmount = "{{ $totalAmountPaid }}";
            ...
            // var advanceAmount = Math.max(paidAmount + paymentAmount - totalAmount, 0);
            var advanceAmount = totalAmount - paymentAmount - paidAmount;
