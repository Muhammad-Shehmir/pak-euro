                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ optional($transaction->customer)->phone_no }}</td>
                                        </tr>
                                        {{-- <tr>
                            ...
                            <table class="table m-0 table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Rate</th>
                                        {{-- <th>Rate</th> --}}
                                        <th style="width: 30px;">Persons / Rooms</th>
                                        <th style="width: 30px;">Days / Dives</th>
                                        {{-- <th>Discount</th>
                                        <th>Tax</th> --}}
                                        <th style="text-align: center">Amount ( {{ $transaction->currency->name }} )</th>
                                ...
                                <tbody>
                                    @foreach ($transaction->transaction_detail as $index => $item)
                                        <tr>
                                            ...
                                            <td style="width: 30px; text-align: center">{{ $item->persons_rooms }}</td>
                                            <td style="width: 30px; text-align: center">{{ $item->days_dives }}</td>
                                            {{-- <td class="">{{ $item->discount ?? 0 }}%</td>
                                            <td class="">{{ $item->tax ?? 0 }}%</td> --}}
                                            {{-- <td class="">{{ $item->amount }}</td> --}}
                                            <td style="text-align: right">{{ $item->converted_amount }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                                        ...
                                        <table class="me-2 mt-4 w-100">
                                            <tbody class="d-flex justify-content-between">
                                                <tr>
                                                    ...
                                                    <td>{{ $transaction->currency->name }} {{ $transaction->sub_total }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-3 pe-3 fw-medium">Discount:</td>
                                                    <td>{{ $transaction->currency->name }}
                                                        {{ $transaction->total_discount_amount ?? 0 }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-3 pe-3 fw-medium">Tax:</td>
                                                    <td>{{ $transaction->currency->name }}
                                                        {{ $transaction->total_tax_amount ?? 0 }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <table class="me-2 mt-4 w-100">
                                            <tbody class="d-flex justify-content-between">
                                                ...
                                                <tr>
                                                    <td class="fw-medium" style="padding-left: 130px">Green Tax :</td>
                                                    <td>{{ $transaction->currency->name }}
                                                        {{ $transaction->total_green_tax_amount ?? 0 }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    @endif
                                    <table class="me-2 mt-4 table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <td class="p-2">{{ $transaction->currency->name }}
                                                    {{ $transaction->total_converted_amount }}</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
