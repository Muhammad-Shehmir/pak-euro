                                        ...
                                        <div class="select2-primary">
                                            <select id="customer_type_id" name="customer_type_id" type="text"
                                                ...
                                                @foreach ($customer_types as $type)
                                                    <option 
                                                    {{ $quote->customer_type_id == $type->id ? 'selected' : '' }}
                                                    value="{{ $type->id }}">
                                                        {{ $type->name }} </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="input-group input-group-merge my-3">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" id="conversion_rate" name="conversion_rate"
                                                id="basic-icon-default-email" value="{{ $quote->conversion_rate }}" class="form-control"
                                            ...
                                            <div class="row w-100 p-2">
                                                <div class="col-md-2 mb-md-0 mb-3">
                                                    ...
                                                    <select class="product-category-dropdown form-select" required
                                                        ...
                                                        @foreach ($product_categories as $category)
                                                            <option {{ $item->product_category_id == $category->id ? 'selected' : '' }}
                                                ...
                                                <div class="col-md-2 mb-md-0 mb-3">
                                                    ...
                                                    <input type="text" class="form-control charges" name="charges"
                                                        required id="charges" placeholder="Enter Charges" value="{{ $item->charges }}" />
                                                </div>
                                                <div class="col-md-2 mb-md-0 mb-3">
                                                    ...
                                                    <input type="text" min="1" max="99999"
                                                        ...
                                                        id="quantity" placeholder="Qty"  value="{{ $item->persons_rooms }}" />
                                                </div>

                                                <div class="col-md-2 mb-md-0 mb-3">
                                                    <p class="mb-2 repeater-title">Amount</p>
                                                    <input type="text" class="form-control amount" name="amount"
                                                        required placeholder="Enter Amount" value="{{ $item->amount }}" />
                                                </div>
                                                <div class="col-md-2 mb-md-0 mb-3">
                                                    <p class="mb-2 repeater-title">Converted Amount</p>
                                                    <input type="text" class="form-control converted-amount"
                                                        name="converted_amount" readonly placeholder="Converted Amount" value="{{ $item->converted_amount }}" />
                                                </div>
                                            </div>
                                            <div
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <span class="fw-semibold d-flex">
                                                <input type="text" name="total_discount_percentage"
                                                    ...
                                                    placeholder="%"
                                                    value="{{ $quote->total_discount_percentage }}" />
