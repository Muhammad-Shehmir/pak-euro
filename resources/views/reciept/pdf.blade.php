            ...
            <div class="card invoice-preview-card" style="border: none !important">
                <div class="col-md-6">
                    <div style="display: inline-block !important; vertical-align: top !important; margin-right: 300px;">
                        <img src="./logo.jpg" width="150px" height="150px" class="mb-2 app-brand-text fw-bold">
                    </div>
                    <div
                        style="display: inline-block !important; vertical-align: top !important; font-size: 14px !important">
                        <h5 class="mb-1">Blueworld</h5>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="font-size: 12px !important; font-weight: bold !important;"
                                            class="pe-3 fw-bold">Guest Name:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 12px !important; text-transform: capitalize !important;">
                                            {{ optional($transaction->customer)->address }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 12px !important; font-weight: bold !important;"
                                        ...
                                        <td style="font-size: 12px !important;">
                                            {{ optional($transaction->customer)->phone_no }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 12px !important; font-weight: bold !important;"
                                            class="pe-3 fw-bold">Source:</td>
                                        <td style="font-size: 12px !important;">
                                            {{ optional($transaction->customer)->customer_source }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 12px !important; font-weight: bold !important;"
                                            class="pe-3 fw-bold"> Invoice Number:
                                        </td>
                                        <td style="font-size: 12px !important;">{{ $transaction->id }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 12px !important; font-weight: bold !important;"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table m-0 table-bordered">
                            <thead>
                                <tr>
                                    <th style="font-size: 12px !important; padding-right: 8px !important; background-color: dodgerblue;">No</th>
                                    <th style="font-size: 12px !important; padding-right: 8px !important; background-color: dodgerblue;">Item and
                                        Description</th>
                                    <th style="font-size: 12px !important; padding-right: 8px !important; background-color: dodgerblue;">Rooms /
                                        Persons</th>
                                    <th style="font-size: 12px !important; padding-right: 8px !important; background-color: dodgerblue;">Days / Dives
                                    <th style="font-size: 12px !important; padding-right: 8px !important; background-color: dodgerblue;">Rate</th>
                                    </th>
                                    <th style="font-size: 12px !important; padding-right: 8px !important; background-color: dodgerblue;">Amount</th>
                                </tr>
                            </thead>
                            <tbody>
                            ...
                            <tfoot>
                                <tr>
                                    <td style="font-size: 10px !important; padding-right:10px !important;"
                                        colspan="5" class="text-end fw-bold">Sub
                                        Total:</td>
                                    <td style="font-size: 10px !important; padding-right:10px !important;"
                                        class="fw-bold">
                                        {{ $transaction->currency->name . ' ' . $transaction->sub_total }}</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 10px !important; padding-right:10px !important;"
                                        colspan="5" class="text-end fw-bold">
                                        General Sales Tax:</td>
                                    <td style="font-size: 10px !important; padding-right:10px !important;">
                                        {{ $transaction->currency->name . ' ' . $transaction->total_tax_amount ?? 0 }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size: 10px !important; padding-right:10px !important;"
                                        colspan="5" class="text-end fw-bold">Service Charge:
                                    </td>
                                    <td style="font-size: 10px !important; padding-right:10px !important;">
                                        {{ $transaction->currency->name . ' ' . $transaction->total_service_charge_amount ?? 0 }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size: 10px !important; padding-right:10px !important;"
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 10px !important; padding-right:10px !important;"
                                        class="fw-bold">
                                        {{ $transaction->currency->name . ' ' . $transaction->total_converted_amount }}
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                ...
                <table class="footer-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 10px !important;">Any dicrepency in the invoice should be reported within 48 hours</td>
                        </tr>
                        <tr>
                            <td style="font-size: 10px !important;">Account Number: 7730000399215</td>
                            <td style="font-size: 10px !important;">Please include invoice Number for Cheque Payments</td>
                        </tr>
                        <tr>
