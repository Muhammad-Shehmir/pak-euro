...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center p-3 py-0">
            <h4 class="fw-bold py-3 mb-2"><a href="{{ url('dashboard') }}" class="text-muted fw-light">Dashboard </a><span class="color">/ Dental Diseases
            </h4></span>
                ...
                <div class="card mb-4">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="d-grid p-3 border">
                            <form method="GET" id="myForm" action="{{ url('/dental-diseases') }}"
                                ...
                                <div class="col-md-7">
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" required class="form-control name-validate" value="{{ request('name') }}"
                                ...
                                <div class="d-flex justify-content-end  p-1 py-1">
                                    ...
                                    <a href="{{ url('/dental-diseases') }}"    class="btn btn-danger" tabindex="0"
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive pt-0 p-3">
                <table class="datatables-basic table table-bordered">
                    ...
                    <tbody>
                        @foreach ($dental_diseases as $dental)
                            <tr>
                                <td>{{ $dental->id }}</td>
                                <td>{{ $dental->name }}</td>
                                <td>
                                             <div class="d-flex align-items-center">
                                        <a class="btn btn-primary me-2 p-2-5"   href="{{ url('/dental-diseases/edit/' . $dental->id) }}"><i
                                                class="fa fa-edit"></i> </a>
                                        <form method="post" action="{{ url('/dental-diseases/delete/' . $dental->id) }}">
                                            @csrf
            ...
            <div class="card-footer d-flex justify-content-end">
                ...
                {{ $dental_diseases->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
    @include('dental_diseases.add')
    <script>
        function changePerPage(select) {
            const perPage = select.value;
            window.location.href = `{{ url('dental-diseases') }}?perPage=${perPage}`;
        }
    </script>
