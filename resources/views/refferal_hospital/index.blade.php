...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center p-3 py-0">
            <h4 class="fw-bold py-3 mb-2"><a href="{{ url('dashboard') }}" class="text-muted fw-light">Dashboard </a><span class="color">/ Refferal Hospital
            </h4></span>
                ...
                <div class="card mb-4">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="d-grid p-3 border">
                            <form method="GET" id="myForm" action="{{ url('/refferal-hospital') }}"
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control name-validate"
                                                ...
                                                aria-label="Enter Name" value="{{ request('name') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" class="form-control name-validate"
                                                id="basic-icon-default-fullname" placeholder="Enter Name" name="admin_name"
                                                aria-label="Enter Name" value="{{ request('admin_name') }}"
                                                aria-describedby="basic-icon-default-fullname2" />
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <input name="admin_phone" type="text" id="basic-icon-default-phone"
                                                value="{{ request('admin_phone') }}"
                                                class="form-control phone-mask number-validate"
                                                placeholder="Enter Phone No." aria-label="Enter Admin Phone No."
                                ...
                                {{-- <div class="col-md-4"> --}}
                                    ...
                                    <div class="d-flex justify-content-end  p-1 py-1">
                                        ...
                                        <a href="{{ url('/refferal-hospital') }}" class="btn btn-danger" tabindex="0"><span><i
        ...
        <div class="card">
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="dt-action-buttons  pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <a href="{{ url('/refferal-hospital/add') }}" class="btn btn-secondary create-new btn-primary"
            ...
            <div class="card-datatable table-responsive pt-0 p-3">
                <table class="datatables-basic table table-bordered">
                    ...
                    <tbody>
                        @foreach ($referral_hospital as $ref)
                            <tr>
                                <td>{{ $ref->id }}</td>
                                <td>{{ $ref->name }}</td>
                                <td>{{ $ref->admin_name }}</td>
                                <td>{{ $ref->admin_phone }}</td>
                                <td>{{ $ref->no_of_referrals }}</td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a class="btn btn-primary me-2 p-2-5"
                                            href="{{ url('/refferal-hospital/edit/' . $ref->id) }}"><i class="fa fa-edit"></i></a>
                                        <form method="post" action="{{ url('/refferal-hospital/delete/' . $ref->id) }}">
                                            @csrf
            ...
            <div class="card-footer d-flex justify-content-end">
                ...
                {{ $referral_hospital->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
    <script>
        function changePerPage(select) {
            ...
            window.location.href = `{{ url('refferal-hospital') }}?perPage=${perPage}`;
        }
    </script>
@endsection
