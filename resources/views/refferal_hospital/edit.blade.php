...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2"><a href="{{ url('/dashboard') }}" class="text-muted fw-light">Dashboard </a><a href="{{ url('/refferal-hospital') }}" class="text-muted fw-light">/ Refferal Hospital</a><span class="color"> /</span><span class="text-heading fw-bold text-color"> Edit</span>
        </h4>
        <div class="row">
            <!-- FormValidation -->
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">Edit No. Of Refferal</h5>
                    <div class="card-body">
                        <form method="POST"  id="myForm" action="{{ url('/refferal-hospital/edit/' . $ref->id) }}"
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" required class="form-control name-validate" id="basic-icon-default-fullname"
                                            placeholder="Enter Name" name="name" value="{{ $ref->name }}"
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" required class="form-control name-validate" id="basic-icon-default-fullname"
                                            placeholder="Enter Name" name="admin_name" value="{{ $ref->admin_name }}"
                                            aria-label="Enter Name" aria-describedby="basic-icon-default-fullname2" />
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input required name="admin_phone" type="text" id="basic-icon-default-phone"
                                            class="form-control phone-mask number-validate" placeholder="Enter Phone No." value="{{ $ref->admin_phone }}"
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input required name="no_of_referrals" type="text" id="basic-icon-default-phone"
                                            class="form-control phone-mask" placeholder="Enter Whatsapp No." value="{{ $ref->no_of_referrals }}"
                                            aria-label="Enter refferal." aria-describedby="basic-icon-default-`2" />
                                        <label for="basic-icon-default-phone">No. Of Refferal</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
